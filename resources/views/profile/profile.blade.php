            ...
            <div class="flex border-[1px] rounded-md">
                <div class="min-w-[10rem] bg-[#6be790f8] py-[2rem] px-[4rem] items-center flex flex-col justify-center">
                    <div class="relative">
                        ...
                        <img src="{{ url(Auth::user()->profile_picture_url) }}" alt="" class="w-[10rem] rounded-[50%]">
                        </div>
                         <button class="text-white text-[18px] hover:text-[#ffd7d7] absolute bottom-0 right-[1rem]">
